    ...
    <div class="flex flex-col h-full gap-6 lg:gap-8 justify-center items-center my-auto">
      ...
      >
        <div class="flex flex-row gap-2">
          ...
          <span v-else class="dark:text-white text-black text-2xl lg:text-4xl font-semibold">
            MESSAGE SENT
          </span>
          ...
          />
          <SolarSmileSquareBold v-else-if="!isLoading && isSuccess" class="self-center h-7 w-7" />
        </div>
      </div>
      ...
      <form @submit.prevent="submitMessage" class="max-w-lg">
        <div class="flex flex-col gap-8">
          <div class="flex flex-row gap-4">
            <div class="animate-in slide-in-from-left-10 duration-500 flex flex-col gap-2 w-[100%]">
              <label
          ...
          <div class="animate-in slide-in-from-bottom-10 duration-500 relative">
            <span class="italic text-ellipsis"
              >The data entered into this form are completely secure, private, and not shared with
              anyone.</span
            >
          </div>
