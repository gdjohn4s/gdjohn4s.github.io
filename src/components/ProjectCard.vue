  ...
  >
    <div class="flex flex-col lg:flex-col h-full w-full p-3">
      <div class="">
        <img
          loading="lazy"
          :src="props.project.imageSrc.toString()"
      ...
      <div class="flex flex-col h-full w-full gap-1 justify-center">
        ...
        <div class="flex flex-row gap-2">
          ...
          <a :href="props.project.linkTo.toString()" target="_blank">
            <ArrowUpOnSquareIcon class="dark:text-white text-black self-center shrink-0 h-5 w-5" />
          </a>
        </div>
      </div>
    </div>
